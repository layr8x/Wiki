...
# 20. ★★ 카카오 수집이 멈추면 = 쿠키가 아니라 "어디서 호출하나"를 먼저 의심 (2026-08-12 실측 확정)
...
## 20-2. 현재 구조 — 전부 맥 스튜디오 launchd (조작 0)
