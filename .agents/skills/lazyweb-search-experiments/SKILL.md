...
# Search Product Experiments

Find real product experiments for pricing, trials, paywalls, monetization, and conversion decisions.
...
Call `lazyweb_search_experiments` and follow its live schema or live tool contract. Include `skill: "lazyweb-search-experiments"` and `version: "0.15.5"` when the schema accepts them.
